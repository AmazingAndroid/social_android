...
public class BrandProfileFragment extends Fragment {
    ...
    public static BrandProfileFragment newInstance(String param1, String param2) {
        BrandProfileFragment fragment = new BrandProfileFragment();
